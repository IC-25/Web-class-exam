...
$stmt = $conn->prepare("SELECT * FROM reception WHERE rid = :rid");
  ...
  <body>
    ...
    <div class="wrapper">
      <div class="form-box register">
        ...
        <form action="insertreceptionupdate.php" method="POST" autocomplete="off">
          <div class="input-box">
            <input type="text" readonly name="recid" value="<?php echo $row['rid'];?>" />
            <label>ID</label>
          </div>
          <div class="input-box">
            <input
