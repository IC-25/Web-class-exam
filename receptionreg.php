   ...
   <header>
    ...
    <div class="wrapper">
      <div class="form-box register">
        ...
        <form action="Registerreceptionist.php" method="POST" autocomplete="off">
          <div class="input-box">
          ...
          <button type="submit" class="btn" name="reception">Add Receptionist</button>
          <div class="login-register"></div>
        </form>
      </div>
 <div class="doctorconte">
  <div class="search">
    <form action="receptionreg.php" method="POST">
    <input type="search" name="search" id="searchfield" placeholder="Search Receptionist Name...">
...
if(isset($_POST["searchbtn"])){
  $search = $_POST["search"];
$sql = "SELECT * FROM `reception` WHERE rfullname LIKE '%$search%' OR rphone LIKE '%$search%'  OR
rusername LIKE '%$search%'";
...
if (mysqli_num_rows($result) > 0) {
  ...
  while($row = mysqli_fetch_assoc($result)) {
      ...
      <tr>
        ...
        <td id="bttn"><form method="post" action="receptionUpdate.php">
          <input type="hidden" name="rid" value="<?php echo $row['rid']?>">
        <input type="submit" id="updatebtn" value="Update"></form>
        <form method="post" action="receptionDelete.php">
          <input type="hidden" name="rid" value="<?php echo $row['rid']?>">
