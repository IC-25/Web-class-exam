...
<html lang="en">
   ...
   <header>
    ...
    <div class="wrapper">
      <div class="form-box register">
        ...
        <form action="Registerpharmacist.php" method="POST" autocomplete="off">
          <div class="input-box">
          ...
          <button type="submit" class="btn" name="pharmacist">Add Pharmacist</button>
  ...
  <div class="search">
    <form action="pharmacistreg.php" method="POST">
    <input type="search" name="search" id="searchfield" placeholder="Search Pharmacist Name...">
...
if(isset($_POST["searchbtn"])){
  $search = $_POST["search"];
$sql = "SELECT * FROM `pharmacist` WHERE pfullname LIKE '%$search%' OR pphone LIKE '%$search%'  OR
pusername LIKE '%$search%'";
...
if (mysqli_num_rows($result) > 0) {
  ...
  while($row = mysqli_fetch_assoc($result)) {
      ...
      <tr>
        ...
        <td id="bttn"><form method="post" action="pharmacistUpdate.php">
          <input type="hidden" name="pid" value="<?php echo $row['pid']?>">
        <input type="submit" id="updatebtn" value="Update"></form>
        <form method="post" action="pharmacistDelete.php">
          <input type="hidden" name="pid" value="<?php echo $row['pid']?>">
